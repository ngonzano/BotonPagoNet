...
<body>
    <div align="center">
        <form id="formBoton" action="http://localhost:1359/CE/Respuesta_PagoCE.aspx" method="post" runat="server">
        <script type="text/javascript" id="javascriptBoton" src='https://static-content-qas.vnforapps.com/v2/js/checkout.js' 
